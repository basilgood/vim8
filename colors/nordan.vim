...
call s:HL('MatchParen',               s:nord3,    s:nord7,   'reverse')
...
call s:HL('cssBraces',                s:nord15,    '',        '')
call s:HL('cssBoxAttr',               s:nord9,    '',        '')
call s:HL('cssClassName',             s:nord7,    '',        '')
call s:HL('cssClassNameDot',          s:nord9,    '',        '')
...
" ===  Coc  =========
call s:HL("CocErrorSign", s:nord11, '', '')
call s:HL("CocWarningSign", s:nord14, '', '')
call s:HL("CocInfoSign", s:nord14, '', '')
call s:HL("CocHintSign", s:nord9, '', '')
call s:HL("CocFadeOut", s:nord11, '', 'none')
call s:HL("CocGitAddedSign", s:nord14, s:nord2, '')
call s:HL("CocGitChangedSign", s:nord13, s:nord2, '')
call s:HL("CocGitChangeRemovedSign", s:nord11, s:nord2, '')
call s:HL("CocGitRemovedSign", s:nord11, s:nord2, '')
