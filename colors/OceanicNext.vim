...
" {{{ Colors
  ...
  let s:base03 = ['#253C43', '243']
  let s:base04 = ['#a7adba', '145']
  let s:base05 = ['#c0c5ce', '251']
  let s:base06 = ['#cdd3de', '252']
  let s:base07 = ['#99a9c6', '253']
  let s:red    = ['#ec5f67', '203']
  let s:orange = ['#c77446', '209']
  let s:yellow = ['#c8a04f', '221']
...
" {{{ call s::hi(group, fg, bg, gui, guisp)
  ...
  call s:hi('PMenuSel',                           s:base07, s:base00, '',          '')
  call s:hi('PmenuSbar',                          '',       s:base02, '',          '')
  call s:hi('PmenuThumb',                         '',       s:base07, '',          '')
  call s:hi('TabLine',                            s:base02, s:base00, 'None',      '')
  call s:hi('TabLineFill',                        s:base01, s:base00, 'None',      '')
  call s:hi('TabLineSel',                         s:base07, s:base00, 'None',      '')
  ...
  call s:hi('Comment',                            s:blue02, '',       s:italic,    '')
