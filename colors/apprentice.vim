...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
  hi Normal           ctermbg=235  ctermfg=250  guibg=#1c1b1a guifg=#bcbcbc cterm=NONE           gui=NONE
  ...
  hi SignColumn       ctermbg=234  ctermfg=242  guibg=#141413 guifg=NONE    cterm=NONE           gui=NONE
  hi ALEWarningSign                             guibg=#141413    guifg=DarkYellow
  hi ALEErrorSign                               guibg=#141413    guifg=DarkMagenta
