...
call arpeggio#map('n', '', 0, 'z1', '1<C-w>w')
call arpeggio#map('n', '', 0, 'z2', '2<C-w>w')
call arpeggio#map('n', '', 0, 'z3', '3<C-w>w')
call arpeggio#map('n', '', 0, 'z4', '4<C-w>w')
call arpeggio#map('n', '', 0, 'z5', '5<C-w>w')
call arpeggio#map('n', '', 0, 'z6', '6<C-w>w')
call arpeggio#map('n', '', 0, 'z7', '7<C-w>w')
call arpeggio#map('n', '', 0, 'z8', '8<C-w>w')
call arpeggio#map('n', '', 0, 'z9', '9<C-w>w')
